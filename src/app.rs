...
use futures::Future;
use zen::super_metroid::level_data::BlockType;
use zen::super_metroid::tile_table::BLOCK_SIZE;
...
lazy_static::lazy_static! {
    ...
    static ref EDITOR_ASSETS: Arc<Mutex<HashMap<BtsTile, ColorImage>>> = Arc::new(Mutex::new(HashMap::new()));
}
...
impl Default for ZenSM {
    fn default() -> Self {
        load_bts_icons(Arc::clone(&EDITOR_ASSETS));
...
#[cfg(target_arch = "wasm32")]
fn load_bts_icons(editor_assets: Arc<Mutex<HashMap<BtsTile, ColorImage>>>) {
